...
VALUES ('great_depression', '1929 세계 경제 대공황',
        '1929년에 시작된 대공황은 전 세계적으로 대규모 경제 붕괴를 초래했습니다. 이로 인해 수백만 명이 일자리를 잃고 수많은 기업이 파산했습니다. 이 시기는 금융 시스템에 대한 신뢰가 크게 흔들렸으며, 경제의 불확실성이 극에 달했습니다. 이러한 극심한 불황 속에서도 일부 산업은 성장했으며, 위기 속에서의 투자 기회를 찾아내는 것이 중요합니다.',
        NOW(), NOW()),

       ('world_war_ii', '1944 2차 세계대전',
        '2차 세계대전 후, 전후 경제 재건을 위해 새로운 국제 경제 질서가 형성되었습니다. 브레튼우즈 체제의 도입으로 미국 달러가 중심이 되는 금융 시스템이 구축되었고, 전 세계의 경제적 안정과 성장을 추구했습니다. 전후 재건과 경제 성장 시기에는 인프라, 산업 재건과 같은 실물 자산에 대한 투자 기회가 많았습니다.',
        NOW(), NOW()),

       ('oil_shock', '1973 오일쇼크',
        '1973년, 중동의 주요 산유국들이 원유 생산을 제한하면서 세계 경제는 큰 혼란에 빠졌습니다. 이로 인해 인플레이션이 급격히 상승했고, 석유 의존도가 높은 국가들은 심각한 경제적 어려움을 겪었습니다. 원자재 가격의 급등은 관련 산업의 주식에 투자 기회를 제공할 수 있으며, 에너지 자원의 중요성을 다시 한 번 인식할 필요가 있습니다.',
        NOW(), NOW()),

       ('lost_decade_japan', '1980 일본의 잃어버린 10년',
        '1980년대 말 일본에서는 자산 가격 거품이 붕괴되어 경제가 장기 침체에 빠졌습니다. 이 시기는 일본 경제의 지속적인 저성장과 디플레이션을 특징으로 하며, 오늘날까지도 중요한 교훈을 남기고 있습니다. 저성장 환경에서는 안정적인 수익을 추구할 수 있는 배당주나 방어적인 산업에 투자하는 것이 유리할 수 있습니다.',
        NOW(), NOW()),

       ('eurozone', '1999 유로존',
        '1999년에 유럽 연합은 단일 통화인 유로를 도입하여 유럽 경제 통합을 촉진했습니다. 이는 유럽 국가들 간의 경제 협력과 무역을 강화하는 중요한 계기가 되었으며, 글로벌 경제에도 큰 영향을 미쳤습니다. 유로존의 통합은 유럽 시장에 대한 투자를 보다 쉽게 만들었으며, 유로화 강세에 따른 수익 기회를 살펴볼 수 있습니다.',
        NOW(), NOW()),

       ('subprime_crisis', '2008 서브프라임 모기지',
        '2008년 미국 주택 시장의 붕괴로 시작된 서브프라임 모기지 사태는 글로벌 금융 위기를 촉발했습니다. 은행들의 파산과 금융 시장의 혼란은 세계 경제에 심각한 타격을 주었으며, 이후 긴 회복 과정을 거쳤습니다. 이러한 금융 위기 속에서도 안정적인 자산에 대한 투자와 방어적인 투자 전략이 필요합니다.',
        NOW(), NOW()),

       ('brexit', '2016 브렉시트',
        '2016년 영국은 국민 투표를 통해 유럽 연합 탈퇴를 결정했습니다. 이로 인해 영국과 유럽 간의 경제적 관계가 불확실해졌고, 글로벌 경제에도 큰 영향을 미치는 정치적, 경제적 변동성이 증가했습니다. 브렉시트와 같은 정치적 리스크는 투자 포트폴리오 다각화의 중요성을 일깨워줍니다.',
        NOW(), NOW()),

       ('crypto_revolution', '2017 암호화폐 혁명',
        '2017년 비트코인을 비롯한 암호화폐가 주류 투자 자산으로 떠오르면서 금융 시스템에 새로운 도전이 시작되었습니다. 암호화폐는 디지털 자산으로서의 가능성을 보여주었으며, 금융의 미래에 대한 다양한 논의가 이루어졌습니다. 암호화폐의 변동성이 높지만, 장기적인 혁신과 기술 발전에 따른 투자 기회를 고려할 수 있습니다.',
        NOW(), NOW()),

       ('covid19_pandemic', '2019 코로나 19 팬데믹',
        '2019년에 시작된 코로나 19 팬데믹은 전 세계적으로 경제 활동을 중단시켰습니다. 글로벌 공급망이 무너지고, 실업률이 급증하는 등 경제 전반에 걸쳐 심각한 타격을 입었으며, 각국은 이를 극복하기 위해 다양한 정책을 시행했습니다. 위기 상황에서는 방어적인 자산과 필수 소비재에 대한 투자 기회가 주목받을 수 있습니다.',
        NOW(), NOW()),

       ('asia_market_crash', '2024 아시아 증시 대폭락',
